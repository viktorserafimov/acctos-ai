// Quick parser test: reads an Pockit PDF, runs full pipeline, saves Excel output.
...
if (!filePath) { console.error('Usage: npx tsx test-pockit.ts <path-to-pdf>'); process.exit(1); }
