/**
 * Santander parser end-to-end test.
 *
 * Run from apps/api/:
 *   npx tsx test-santander.ts "<path-to-pdf>"
 *
...
import { parse } from './src/services/processing/parsers/santander.js';
import type { Cell } from './src/services/processing/parsers/shared.js';

const pdfPath = process.argv[2];
if (!pdfPath) { console.error('Usage: npx tsx test-santander.ts "<pdf path>"'); process.exit(1); }

const cachePath = pdfPath.replace(/\.pdf$/i, '') + '_santander_cache.json';
