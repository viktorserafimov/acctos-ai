// Quick parser test: reads an RBS PDF, runs full pipeline, saves Excel output.
...
if (!filePath) { console.error('Usage: npx tsx test-rbs.ts <path-to-pdf>'); process.exit(1); }
